...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_fir_f32(const arm_fir_instance_f32 * S, float * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_biquad_cascade_df1_f32(const arm_biquad_casd_df1_inst_f32 * S, float * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * <code>ARM_MATH_SIZE_MISMATCH</code> or <code>ARM_MATH_SUCCESS</code> based on the outcome of size checking.
   */
arm_status arm_mat_scale_f32(const arm_matrix_instance_f32 * pSrc, float scale, arm_matrix_instance_f32 * pDst);
...
/**
   ...
   * @param[in]     pData     points to the matrix data array.
   */
void arm_mat_init_f32(arm_matrix_instance_f32 * S, uint16_t nRows, uint16_t nColumns, float * pData);
...
/* Deprecated */
void arm_cfft_radix2_f32(const arm_cfft_radix2_instance_f32 * S, float * pSrc);
...
/* Deprecated */
void arm_cfft_radix4_f32(const arm_cfft_radix4_instance_f32 * S, float * pSrc);
...
typedef struct
{
  ...
  uint8_t bitReverseFlagR;              /**< flag that enables (bitReverseFlagR=1) or disables (bitReverseFlagR=0) bit reversal of output. */
  uint32_t twidCoefRModifier;           /**< twiddle coefficient modifier that supports different size FFTs with the same twiddle factor table. */
  float * pTwiddleAReal;                /**< points to the real twiddle factor table. */
  float * pTwiddleBReal;                /**< points to the imag twiddle factor table. */
...
void arm_rfft_f32(const arm_rfft_instance_f32 * S, float * pSrc, float * pDst);
...
typedef struct
{
  ...
  float normalize;                      /**< normalizing factor. */
  float * pTwiddle;                     /**< points to the twiddle factor table. */
  float * pCosFactor;                   /**< points to the cosFactor table. */
...
/**
   ...
   */
arm_status arm_dct4_init_f32(arm_dct4_instance_f32 * S, arm_rfft_instance_f32 * S_RFFT, arm_cfft_radix4_instance_f32 * S_CFFT, uint16_t N, uint16_t Nby2, float normalize);
...
/**
   ...
   */
void arm_dct4_f32(const arm_dct4_instance_f32 * S, float * pState, float * pInlineBuffer);
...
/**
   ...
   * @param[in]  blockSize  number of samples in each vector
   */
void arm_add_f32(float * pSrcA, float * pSrcB, float * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  number of samples in each vector
   */
void arm_abs_f32(float * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  number of samples in the vector
   */
void arm_negate_f32(float * pSrc, float * pDst, uint32_t blockSize);
 ...
 */
void arm_conv_f32(float * pSrcA, uint32_t srcALen, float * pSrcB, uint32_t srcBLen, float * pDst);
...
/**
   ...
   */
arm_status arm_conv_partial_f32(float * pSrcA, uint32_t srcALen, float * pSrcB, uint32_t srcBLen, float * pDst, uint32_t firstIndex, uint32_t numPoints);
...
/**
   ...
   */
arm_status arm_fir_decimate_init_f32(arm_fir_decimate_instance_f32 * S, uint16_t numTaps, uint8_t M, float * pCoeffs, float * pState, uint32_t blockSize);
...
typedef struct
{
  uint8_t L;            /**< upsample factor. */
  uint16_t phaseLength; /**< length of each polyphase filter component. */
  float * pCoeffs;      /**< points to the coefficient array. The array is of length L*phaseLength. */
  float * pState;       /**< points to the state variable array. The array is of length phaseLength+numTaps-1. */
...
/**
   ...
   * @param[in]  blockSize  number of input samples to process per call.
   */
void arm_fir_interpolate_f32(const arm_fir_interpolate_instance_f32 * S, float * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * the filter length <code>numTaps</code> is not a multiple of the interpolation factor <code>L</code>.
   */
arm_status arm_fir_interpolate_init_f32(arm_fir_interpolate_instance_f32 * S, uint8_t L, uint16_t numTaps, float * pCoeffs, float * pState, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_biquad_cascade_df2T_f32(const arm_biquad_cascade_df2T_instance_f32 * S, float * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_biquad_cascade_stereo_df2T_f32(const arm_biquad_cascade_stereo_df2T_instance_f32 * S, float * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]     pState     points to the state buffer.
   */
void arm_biquad_cascade_df2T_init_f32(arm_biquad_cascade_df2T_instance_f32 * S, uint8_t numStages, float * pCoeffs, float * pState);
...
/**
   ...
   * @param[in]     pState     points to the state buffer.
   */
void arm_biquad_cascade_stereo_df2T_init_f32(arm_biquad_cascade_stereo_df2T_instance_f32 * S, uint8_t numStages, float * pCoeffs, float * pState);
...
{
  uint16_t numStages; /**< number of filter stages. */
  float * pState;     /**< points to the state variable array. The array is of length numStages. */
  float * pCoeffs;    /**< points to the coefficient array. The array is of length numStages. */
 ...
 * @param[in] pState     points to the state buffer.  The array is of length numStages.
 */
void arm_fir_lattice_init_f32(arm_fir_lattice_instance_f32 * S, uint16_t numStages, float * pCoeffs, float * pState);
...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_fir_lattice_f32(const arm_fir_lattice_instance_f32 * S, float * pSrc, float * pDst, uint32_t blockSize);
...
{
  uint16_t numStages; /**< number of stages in the filter. */
  float * pState;     /**< points to the state variable array. The array is of length numStages+blockSize. */
  float * pkCoeffs;   /**< points to the reflection coefficient array. The array is of length numStages. */
  float * pvCoeffs;   /**< points to the ladder coefficient array. The array is of length numStages+1. */
...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_iir_lattice_f32(const arm_iir_lattice_instance_f32 * S, float * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in] blockSize  number of samples to process.
   */
void arm_iir_lattice_init_f32(arm_iir_lattice_instance_f32 * S, uint16_t numStages, float * pkCoeffs, float * pvCoeffs, float * pState, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_lms_f32(const arm_lms_instance_f32 * S, float * pSrc, float * pRef, float * pOut, float * pErr, uint32_t blockSize);
...
/**
   ...
   * @param[in] blockSize  number of samples to process.
   */
void arm_lms_init_f32(arm_lms_instance_f32 * S, uint16_t numTaps, float * pCoeffs, float * pState, float mu, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  number of samples to process.
   */
void arm_lms_norm_f32(arm_lms_norm_instance_f32 * S, float * pSrc, float * pRef, float * pOut, float * pErr, uint32_t blockSize);
...
/**
   ...
   * @param[in] blockSize  number of samples to process.
   */
void arm_lms_norm_init_f32(arm_lms_norm_instance_f32 * S, uint16_t numTaps, float * pCoeffs, float * pState, float mu, uint32_t blockSize);
...
/**
   ...
   */
void arm_correlate_f32(float * pSrcA, uint32_t srcALen, float * pSrcB, uint32_t srcBLen, float * pDst);
...
typedef struct
{
  ...
  float * pState;      /**< points to the state buffer array. The array is of length maxDelay+blockSize-1. */
  float * pCoeffs;     /**< points to the coefficient array. The array is of length numTaps.*/
...
/**
   ...
   * @param[in]  blockSize   number of input samples to process per call.
   */
void arm_fir_sparse_f32(arm_fir_sparse_instance_f32 * S, float * pSrc, float * pDst, float * pScratchIn, uint32_t blockSize);
...
/**
   ...
   */
void arm_fir_sparse_init_f32(arm_fir_sparse_instance_f32 * S, uint16_t numTaps, float * pCoeffs, float * pState, int32_t * pTapDelay, uint16_t maxDelay, uint32_t blockSize);
...
/**
   ...
   */
void arm_cmplx_conj_f32(float * pSrc, float * pDst, uint32_t numSamples);
...
/**
   ...
   */
void arm_cmplx_mag_squared_f32(float * pSrc, float * pDst, uint32_t numSamples);
...
/**
   ...
   */
CMSIS_INLINE __STATIC_INLINE float arm_pid_f32(arm_pid_instance_f32 * S, float in)
{
  float out;
...
/**
   ...
   */
CMSIS_INLINE __STATIC_INLINE void arm_clarke_f32(float Ia, float Ib, float * pIalpha, float * pIbeta)
{
  /* Calculate pIalpha using the equation, pIalpha = Ia */
  *pIalpha = Ia;

  /* Calculate pIbeta using the equation, pIbeta = (1/sqrt(3)) * Ia + (2/sqrt(3)) * Ib */
  *pIbeta = ((float)0.57735026919 * Ia + (float)1.15470053838 * Ib);
}
...
/**
   ...
   */
CMSIS_INLINE __STATIC_INLINE void arm_inv_clarke_f32(float Ialpha, float Ibeta, float * pIa, float * pIb)
{
...
/**
   ...
   *
   */
CMSIS_INLINE __STATIC_INLINE void arm_park_f32(float Ialpha, float Ibeta, float * pId, float * pIq, float sinVal, float cosVal)
{
...
/**
   ...
   */
void arm_q7_to_float(q7_t * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]  cosVal   cosine value of rotation angle theta
   */
CMSIS_INLINE __STATIC_INLINE void arm_inv_park_f32(float Id, float Iq, float * pIalpha, float * pIbeta, float sinVal, float cosVal)
{
...
/**
   ...
   * @param[in]  blockSize  is the number of samples to process
   */
void arm_q31_to_float(q31_t * pSrc, float * pDst, uint32_t blockSize);
...
/**
   ...
   *
   */
CMSIS_INLINE __STATIC_INLINE float arm_linear_interp_f32(arm_linear_interp_instance_f32 * S, float x)
{
  float y;
  float x0, x1;                 /* Nearest input values */
  float y0, y1;                 /* Nearest output values */
  float xSpacing = S->xSpacing; /* spacing between input values */
  int32_t i;                    /* Index variable */
  float * pYData = S->pYData;   /* pointer to output table */
...
/**
   ...
   */
CMSIS_INLINE __STATIC_INLINE arm_status arm_sqrt_f32(float in, float * pOut)
{
  if (in >= 0.0f) {
...
CMSIS_INLINE __STATIC_INLINE void arm_circularRead_f32(
  int32_t * circBuffer, int32_t L, int32_t * readOffset, int32_t bufferInc, int32_t * dst, int32_t * dst_base, int32_t dst_length, int32_t dstInc, uint32_t blockSize)
{
  uint32_t i = 0U;
...
CMSIS_INLINE __STATIC_INLINE void arm_circularRead_q15(
  q15_t * circBuffer, int32_t L, int32_t * readOffset, int32_t bufferInc, q15_t * dst, q15_t * dst_base, int32_t dst_length, int32_t dstInc, uint32_t blockSize)
{
  uint32_t i = 0;
  int32_t rOffset, dst_end;
...
CMSIS_INLINE __STATIC_INLINE void arm_circularRead_q7(
  q7_t * circBuffer, int32_t L, int32_t * readOffset, int32_t bufferInc, q7_t * dst, q7_t * dst_base, int32_t dst_length, int32_t dstInc, uint32_t blockSize)
{
  uint32_t i = 0;
  int32_t rOffset, dst_end;
...
/**
   ...
   * @param[out] pResult    is output value.
   */
void arm_power_f32(float * pSrc, uint32_t blockSize, float * pResult);
...
/**
   ...
   * @param[out] pResult    is output value.
   */
void arm_rms_f32(float * pSrc, uint32_t blockSize, float * pResult);
...
/**
   ...
   * @param[out] imagResult  imaginary part of the result returned here
   */
void arm_cmplx_dot_prod_f32(float * pSrcA, float * pSrcB, uint32_t numSamples, float * realResult, float * imagResult);
...
/**
   ...
   * @param[in]  numSamples  number of samples in each vector
   */
void arm_cmplx_mult_real_f32(float * pSrcCmplx, float * pSrcReal, float * pCmplxDst, uint32_t numSamples);
...
/**
   ...
   * @param[in]  numSamples  number of complex samples in each vector
   */
void arm_cmplx_mult_cmplx_f32(float * pSrcA, float * pSrcB, float * pDst, uint32_t numSamples);
...
/**
   ...
   * @param[in]  blockSize  length of the input vector
   */
void arm_float_to_q15(float * pSrc, q15_t * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  length of the input vector
   */
void arm_float_to_q7(float * pSrc, q7_t * pDst, uint32_t blockSize);
...
/**
   ...
   * @param[in]  blockSize  is the number of samples to process
   */
void arm_q15_to_float(q15_t * pSrc, float * pDst, uint32_t blockSize);
...
/**
  ...
  */
CMSIS_INLINE __STATIC_INLINE float arm_bilinear_interp_f32(const arm_bilinear_interp_instance_f32 * S, float X, float Y)
{
  float out;
